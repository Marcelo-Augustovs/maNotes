...
public class AtualizarRelatorioDialog {

    public static Optional<Pair<Integer, Integer>> show() {
        Dialog<Pair<Integer, Integer>> dialog = new Dialog<>();
        dialog.setTitle("Atualizar Relatório Mensal");
        dialog.setHeaderText("Selecione o mês e o ano");

        ButtonType gerarButtonType = new ButtonType("Atualizar", ButtonBar.ButtonData.OK_DONE);
